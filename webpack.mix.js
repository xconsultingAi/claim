...
mix.js('resources/js/scripts/private-clinic/bank-details/add-bank.js', 'public/js')
   .js('resources/js/scripts/private-clinic/bank-details/index.js', 'public/js')
   .js('resources/js/scripts/private-clinic/Expense/Expense-Category/index.js', 'public/js')
   .js('resources/js/scripts/private-clinic/Expense/Expense-Category/add-category.js', 'public/js')
   .version();
...
mix
  .css('resources/css/bootstrap/bootstrap.min.css', 'public/css/bootstrap', { sassOptions })
  .js('resources/js/core/app-menu.js', 'public/js/core')
  .js('resources/js/core/app.js', 'public/js/core')
  .js('resources/assets/js/scripts.js', 'public/js/core')
  .js('resources/js/core/app.js', 'build/js')
  ...
  .sass('resources/assets/sass/app.scss', 'build/css')
  .styles([
    'resources/css/flatpickr/dist/plugins/monthSelect/style.css',
  ], 'public/css/app.css');
