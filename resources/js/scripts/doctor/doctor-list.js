...
$(function () {
  ...
  function fetchDoctorCountDetail() {
    $.ajax({
      url: baseurl + '/doctor/get-doctor-count',
      type: 'GET',
      data:  {},
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'doctor/get-doctor-list', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            // var roleBadgeObj = {
            //   1: feather.icons['user'].toSvg({ class: 'font-medium-3 text-primary me-50' }),
            //   2: feather.icons['settings'].toSvg({ class: 'font-medium-3 text-warning me-50' }),
            //   3: feather.icons['database'].toSvg({ class: 'font-medium-3 text-success me-50' }),
            //   4: feather.icons['edit-2'].toSvg({ class: 'font-medium-3 text-info me-50' }),
            //   5: feather.icons['slack'].toSvg({ class: 'font-medium-3 text-danger me-50' })
            // };
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="' +
              baseurl + '/doctor/add-doctor/' + full.id +
              '" class="dropdown-item">' +
  ...
  $(document).on('click', '.delete-record', function (e) {
    ...
    Swal.fire({
      ...
      $.ajax({
        url: assetPath + 'doctor/delete/' + user_id,
        method: 'DELETE',
        headers: {
  ...
  $(".add-user").click(function(){
    window.location.pathname = 'doctor/add-doctor';
  }); 
