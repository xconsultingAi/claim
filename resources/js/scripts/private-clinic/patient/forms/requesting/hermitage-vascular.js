...
function createUpdateHermitage(formData_id, formData) {
    var hermitageUpdate = 'requesting-form/hermitage-vascular-update';
    var hermitageCreate = 'requesting-form/hermitage-vascular-store';
        ...
        success: function (response) {
            ...
            if (response.status === 'success') {
                Swal.fire(swalConfig).then(function (result) {
                    window.location.href = baseurl + '/private-clinic/patient/requesting-form/hermitage-vascular/' + formdata + '/' + id;
                });
            } else {
