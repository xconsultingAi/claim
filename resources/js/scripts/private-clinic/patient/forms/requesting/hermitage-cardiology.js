...
function createUpdateHermitage(formData_id,formData) {
    var hermitageUpdate= 'requesting-form/hermitage-cardiology-update';
    var hermitageCreate= 'requesting-form/hermitage-cardiology-store';
    var url = formData_id ? baseurl + '/private-clinic/patient/'+ hermitageUpdate +'/' + formData_id : baseurl + '/private-clinic/patient/'+hermitageCreate;
      ...
      success: function (response) {
        ...
        if (response.status === 'success') {
          Swal.fire(swalConfig).then(function (result) {
            window.location.href = baseurl + '/private-clinic/patient/requesting-form/hermitage-cardiology/' + formdata + '/' + id;
          });
        } else {
