...
function createUpdateHermitage(formData_id, formData) {
    var beaconeUpdate = 'requesting-form/hermitage-ncs-update';
    var beaconCreate = 'requesting-form/hermitage-ncs-store';
        ...
        success: function (response) {
            ...
            if (response.status === 'success') {
                Swal.fire(swalConfig).then(function (result) {
                    window.location.href = baseurl + '/private-clinic/patient/requesting-form/hermitage-ncs/' + formdata + '/' + id;
                });
            } else {
