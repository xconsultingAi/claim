...
function createUpdateBeacon(formData_id, formData) {
    var beaconeUpdate = 'requesting-form/hermitage-clinical-update';
    var beaconCreate = 'requesting-form/hermitage-clinical-store';
        ...
        success: function (response) {
            ...
            if (response.status === 'success') {
                Swal.fire(swalConfig).then(function (result) {
                    window.location.href = baseurl + '/private-clinic/patient/requesting-form/hermitage-laboratory/' + formdata + '/' + id;
                });
            } else {
