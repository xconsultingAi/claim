...
function createUpdateBlackrock(formData_id, formData) {
    var beaconeUpdate = 'requesting-form/blackrock-update';
    var beaconCreate = 'requesting-form/blackrock-store';
        ...
        success: function (response) {
            ...
            if (response.status === 'success') {
                Swal.fire(swalConfig).then(function (result) {
                    window.location.href = baseurl + '/private-clinic/patient/requesting-form/blackrock-report/' + formdata + '/' + id;
                });
            } else {
