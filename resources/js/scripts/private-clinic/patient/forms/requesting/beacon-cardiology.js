...
function createUpdateBeacon(formData_id, formData) {
    var beaconeUpdate = 'requesting-form/beacon-cardiology-update';
    var beaconCreate = 'requesting-form/beacon-cardiology-store';
        ...
        success: function (response) {
            ...
            if (response.status === 'success') {
                Swal.fire(swalConfig).then(function (result) {
                    window.location.href = baseurl + '/private-clinic/patient/requesting-form/beacon-cardiology/' + formdata + '/' + id;
                });
            } else {
