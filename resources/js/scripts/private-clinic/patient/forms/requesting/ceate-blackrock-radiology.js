...
function createUpdateBlackrock(formData_id, formData) {
    var blackrockUpdate = 'requesting-form/blackrock-radio-update';
    var blackrockCreate = 'requesting-form/blackrock-radio-store';
    var url = formData_id ? baseurl + '/private-clinic/patient/' + blackrockUpdate + '/' + formData_id : baseurl + '/private-clinic/patient/' + blackrockCreate;
        ...
        success: function (response) {
            ...
            if (response.status === 'success') {
                Swal.fire(swalConfig).then(function (result) {
                    window.location.href = baseurl + '/private-clinic/patient/requesting-form/blackrock-radio/' + formdata + '/' + id;
                });
            } else {
