...
$(function () {
    ('use strict');
    var dtUserTable = $('.company-type-list-table'),
      statusObj = {
    ...
    if (dtUserTable.length) {
       ...
       $('.company-type-list-table thead tr').clone(true).appendTo('.company-type-list-table thead');
       $('.company-type-list-table thead tr:eq(1) th').each(function (i) {
         if (i < $('.company-type-list-table thead tr:eq(1) th').length - 1) {
           var title = $(this).text();
      ...
      var dt_filter = dtUserTable.DataTable({
        ajax: assetPath + 'company/get-company-list',
        columns: [
    ...
    $(document).on('click', '.delete-record', function (e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: assetPath + 'company/delete/'+ type_id,
            method: 'DELETE',
            headers: {
    ...
    $(document).on('click', '.edit-record', function (e) {
      e.preventDefault();
      var type_id = $(this).data('type_id');
      window.location.href = baseurl+`/company/${type_id}/edit`;
    });
