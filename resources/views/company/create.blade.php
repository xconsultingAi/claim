      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-1 col-md-12">
              ...
              <input type="text" name="name" id="name" class="form-control" value="" placeholder="john" required />
            </div>
            <div class="mb-1 col-md-12">
              <label class="form-label" for="mobile_no">Mobile Number</label>
              <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="(472) 765-3654" />
            </div>
            ...
            <div class="mb-1 col-md-12">
              ...
              <input type="text" name="email" id="email" class="form-control" placeholder="Abc@mailinator.com" />
            </div>

            <div class="mb-1 col-md-12">
              <label class="form-label" for="password">Password</label>
              <input type="password" name="password" id="password" class="form-control" placeholder="Abc@mailinator.com" />
            </div>     
              <div class="col-12">
